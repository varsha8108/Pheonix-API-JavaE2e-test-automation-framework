...
import com.dataprovider.dataproviderutils;
...
@Test(description = "Verify if Login test for API is working as expected",
groups = {"api","Regression","Smoke"},
dataProviderClass = dataproviderutils.class,
dataProvider = "loginapijsondataprovider")
	public void loginapitest(usercred uc) throws IOException {
		
		
		Response r=given()
		.spec(specbuilder.requestspec(uc))
		.when()
		.post("login")
		.then()
